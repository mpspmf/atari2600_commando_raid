...
'''
primeira_passagem1 = 0
primeira_passagem2 = 0
...
heli = pygame.image.load('desenho12.png')
heli_v1 = pygame.image.load('g171.png')
heli1 = pygame.image.load('desenho13.png')
heli1_v1 = pygame.image.load('g172.png')
...
while running == True:
    ...
    if tunel[2] != 1:
        if keys[pygame.K_LEFT] and angle >= -145:
            angle += -0.3 * dt
        if keys[pygame.K_RIGHT] and angle <= -45:
            angle += 0.3 * dt
...
#paraquedista 
    ...
    for i in range(4):
        if heli_1_xpos > houses[i][1][0] and drop_1[i] == 1 and pd1 == True:
    ...
    for i in range(3, -1, -1):
        if heli_2_xpos < houses[i][1][0]+40 and drop_2[i] == 1 and pd2 == True:
    ...
    for i in tiros:
        ...
        elif overlaps(390, bomb_ypos, 24, 21, i[0][0], i[0][1], 4, 4):
            tiros.remove(i)
            bomb_draw = False
            bomb_ypos = 90
    ...
    for k,i in enumerate(tunel):
        ...
        if k == 1 and i == 2:
            pygame.draw.rect(screen, LIGHT_ORANGE, (210, 455, 20, 60))
            pygame.draw.rect(screen, LIGHT_ORANGE, (210, 515, 200, 20))
        
        if k == 3 and i == 1:
            pygame.draw.rect(screen, LIGHT_ORANGE, (570, 455, 20, 60))
        if k == 3 and i == 2:
            pygame.draw.rect(screen, LIGHT_ORANGE, (570, 455, 20, 60))
            pygame.draw.rect(screen, LIGHT_ORANGE, (390, 515, 200, 20))
...
'''
    #helicopter
    if heli_draw_timer != 0:
        heli_draw_timer = round(heli_draw_timer - 0.1, 1)
    if heli_draw_timer1 != 0:
        heli_draw_timer1 = round(heli_draw_timer1 - 0.1, 1)
    ...
    if counter > 0:
        ...
        if xpos1 < 800 and heli_draw_timer == 0:  # criar nave1
            if primeira_passagem1 == 0:
                primeira_passagem1 = 1
                lancar1 = [randint(0, 1) for _ in range(4)]
            xpos1 = xpos1 + 0.2*dt
            ...
            lancar1 = [randint(0, 1) for _ in range(4)]
            xpos1 = -50
            if (xpos1 + 150 >= xpos2) and heli_draw1 == True:
                ypos1 = 10
            else:
                ypos1 = 60
                
        if xpos2 > -30 and heli_draw_timer1 == 0:  # criar nave2
            if primeira_passagem2 == 0:
                primeira_passagem2 = 1
                lancar2 = [randint(0, 1) for _ in range(4)]
            xpos2 = xpos2 - 0.2*dt
        ...
        if ((xpos1 + 150 >= xpos2 and xpos1 - 140 <= xpos2) or (xpos1 + 150 - 800 >= xpos2 and xpos1 - 140 -800 <= xpos2)) and heli_draw1 == True:
            change_pos = True
        else:
            change_pos = False
        if change_pos == True:
